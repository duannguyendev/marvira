                ...
                case 0:
                  return [
                    ...
                    prisma.place.upsert({
                      where: { id: place.id },
                      update: {},
                      create: __assign(__assign({}, place), {
                        eventId: event.id,
                        radiusMeters: 100,
                      }),
                    }),
                ...
                case 1:
                  ...
                  questions = [
                    ...
                    },
                    {
                      ...
                      question:
                        'The Ferry Building clock is modeled after which famous tower?',
                    ...
                    },
                    {
                      ...
                      question:
                        'Coit Tower was built with funds from Lillie Hitchcock Coit.',
                  ...
                  q = questions.find(function (q) {
                    return q.placeId === place.id;
                  });
          ...
          return [
            ...
            prisma.event.create({
              data: {
                ...
                description:
                  'A scenic hunt along the iconic Golden Gate Bridge area.',
                city: 'San Francisco',
            ...
            prisma.place.create({
              data: {
                ...
                question: {
                  create: {
                    question:
                      'What color is the Golden Gate Bridge officially painted?',
                    type: client_1.QuestionType.TEXT,
