  ...
  return (
    <div className="space-y-4 text-base leading-relaxed text-ink/80">
      <ReactMarkdown
        ...
        components={{
          h1: (props) => (
            <h1 className="mt-8 font-display text-3xl font-bold text-ink" {...props} />
          ),
          h2: (props) => (
            <h2 className="mt-8 font-display text-2xl font-bold text-ink" {...props} />
          ),
          h3: (props) => (
            <h3 className="mt-6 font-display text-xl font-bold text-ink" {...props} />
          ),
          p: (props) => <p className="text-ink/80" {...props} />,
          ul: (props) => <ul className="list-disc space-y-2 pl-6 text-ink/80" {...props} />,
          ol: (props) => <ol className="list-decimal space-y-2 pl-6 text-ink/80" {...props} />,
